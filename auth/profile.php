...
<div class="container py-5">
  ...
  <div class="card shadow-sm p-4 rounded-4 mx-auto" style="max-width:600px;">
    ...
    <form method="POST" enctype="multipart/form-data" class="d-flex flex-column gap-3">
      ...
      <p class="image-preview" id="image-preview">
        <img id="preview-img" src="#" alt="Avatar Preview" class="rounded-circle border-lg mb-2" style="width:180px; height:180px; object-fit:cover; display:none;">
      </p>
